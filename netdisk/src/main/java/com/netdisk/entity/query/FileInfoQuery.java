...
public class FileInfoQuery extends BaseParam {
     ...
     * 模糊查询 - 权限类别
     */
    private Integer permissionFuzzy;

    /**
     * 模糊查询 - 权限类型
     */
    private Integer accessTypeFuzzy;
    ...
    public Integer getPermissionFuzzy() {
        return permissionFuzzy;
    }

    public void setPermissionFuzzy(Integer permissionFuzzy) {
        this.permissionFuzzy = permissionFuzzy;
    }

    public Integer getAccessTypeFuzzy() {
        return accessTypeFuzzy;
    }

    public void setAccessTypeFuzzy(Integer accessTypeFuzzy) {
        this.accessTypeFuzzy = accessTypeFuzzy;
    }
