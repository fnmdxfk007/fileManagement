...
public interface FileInfoService {
     ...
     *  查询公开文件
     */
    PaginationResultVO<FileInfo> loadPublicFileList(FileInfoQuery query);

    PaginationResultVO<FileInfo> loadCollectPublicFileList(FileInfoQuery query);
    ...
    UploadResultDto uploadFile(SessionWebUserDto webUserDto, String fileId, MultipartFile file, String fileName, String filePid, String fileMd5, Integer chunkIndex,
                               Integer chunks,Integer permission,Integer accessType,String description);

    FileInfo rename(String fileId, String userId, String fileName);

    FileInfo newFolder(String filePid, String userId, String folderName,Integer permission,Integer accessType);
    ...
    void updateFileDescription(@Param("fileId")String fileId,@Param("userId") String userId, String description);

    void setIsPublic(String fileId, String userId, Integer permission, Integer accessType);
